...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('storage/images/welcome_page/DUOQLO.png')}}">
...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
        ...
        <a href="/m-home"><img src ="{{asset('storage/images/welcome_page/DUOQLO.png')}}" style="width: 50px; height:50px" alt="" srcset=""></a>
