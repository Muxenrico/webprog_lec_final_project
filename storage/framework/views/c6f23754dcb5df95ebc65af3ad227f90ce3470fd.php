...
<?php $__env->startSection('body'); ?>
    ...
    <div class="p-5 m-5">
        <div class="border pb-5 col-8 mx-auto d-flex flex-column justify-content-center align-items-center mt-5">
            <div class="row mx-auto">
                ...
                <form action="/add-to-cart/<?php echo e($currProduct->id); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="container">
                        <div class="row text-center">
                            ...
                            <div class="col d-flex flex-column">
                                <button id="quantity" type="submit" class="btn btn-success">Add To Cart</button>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col d-flex flex-column">
...
<?php echo $__env->make('Component.navbarmember', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\College\5th Semester Material\Web Programming\Project\WebProg_Project_Final v1.3\resources\views/showMemberProductDetail.blade.php ENDPATH**/ ?>