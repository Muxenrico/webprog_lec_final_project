        ...
        <div class="container-fluid">
            ...
            <div class="container d-flex flex-row justify-content-end">
                <div class="row d-flex align-items-center">
                    ...
                    <form class="col" action="<?php echo e(route('logout')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH D:\College\5th Semester Material\Web Programming\Project\WebProg_Project_Final v1.3\resources\views/Component/navbaradmin.blade.php ENDPATH**/ ?>