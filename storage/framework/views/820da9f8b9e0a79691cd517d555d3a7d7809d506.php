        ...
        <div class="border col-8 mx-auto d-flex flex-column justify-content-center align-items-center mt-5">
            <div class="row mx-auto">
                <div class="col align-items-center m-3 mx-auto">
                    <img src="<?php echo e(asset('images/clothes/'.$currProduct->image)); ?>" class="img-fluid img-thumbnail" alt="Image Not Found">
                </div>
                    ...
                    <div class="border-top border-secondary">
                        <div class="container">
                            <div class="row mt-3">
                                ...
                                <div class="col">
                                    <a href="/" type="submit" class="btn btn-danger">Delete Item</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('Component.navbaradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Chrome Downloads\Project WebProg\WebProg_Project_Final\resources\views/showAdminProductDetail.blade.php ENDPATH**/ ?>